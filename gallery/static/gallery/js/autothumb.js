    ...
    fileInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            generateThumbnail(url);
                ...
                alert('Пожалуйста, выберите GLB или GLTF файл');
                previewContainer.innerHTML = '<div style="padding: 80px 0; text-align: center; color: #999;">Выберите файл...</div>';
        }
    });
}

function generateThumbnail(modelUrl) {
      // Сохраняем placeholder текст
    const placeholder = '<div style="padding: 80px 0; text-align: center; color: #999;">Генерация превью...</div>';
